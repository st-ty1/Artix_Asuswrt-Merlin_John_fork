...
Enclosed you will find two shell scripts (for mips and arm) for setting path variables, resetting and cleaning your local repo, inserting the needed files ( after steps 3.-6.), removing the troublesome files (step 10.) and applying the needed patches (step 7.-9./11.-12.) to source code of your local repo. 
So, the easiest way is to just do step 1. to 6. and then start the shell script for MIPS- or ARM-builds (Don't forget to make the script executable before!)
