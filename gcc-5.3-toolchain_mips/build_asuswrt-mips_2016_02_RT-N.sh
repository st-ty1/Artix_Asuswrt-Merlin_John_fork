...
## compressed kernel
patch -i $ASUSWRT_PATCHES_DIR/bzip2_inflate.c_RT-N.patch $ASUSWRT_REPO_DIR/release/src-rt/shared/bzip2_inflate.c 
...
## router/utils	only needed for RT-N
patch -i $ASUSWRT_PATCHES_DIR/Makefile_utils.patch $ASUSWRT_REPO_DIR/release/src/router/utils/Makefile
